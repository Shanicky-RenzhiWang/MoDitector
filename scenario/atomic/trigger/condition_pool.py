...
from scenario.common.scenario_helper import get_distance_along_route
from scenario.common.atomic_behavior import calculate_distance
...
class InTriggerDistanceToOSCPosition(AtomicCondition):
    ...
    def update(self):
        ...
        osc_transform = scenario.common.openscenario_parser.OpenScenarioParser.convert_position_to_transform(
            self._osc_position)
...
class InTriggerDistanceToLocationAlongRoute(AtomicCondition):
    ...
    def update(self):
        ...
        if current_location.distance(self._location) < self._distance + 20:
            ...
            if (actor_distance + self._distance > self._location_distance > actor_distance) or self._location_distance < 1.0:
                new_status = py_trees.common.Status.SUCCESS
